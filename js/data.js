var SQUARES = [
  ...
  { id:2,  type:'task',  name:'【默契大考驗】',          desc:'請到主日學教室，全員合力將氣球拍進呼拉圈裡。',                                                             name2:'搬運挑戰',         desc2:'請到禮拜堂，全隊接力搬東西回原位，速度越快分數越高',        damage:10 },
  ...
  { id:4,  type:'task',  name:'【K歌王】',               desc:'請到禮拜堂，挑一首詩歌，大合唱',                                                                           name2:'舞力全開',         desc2:'請到禮拜堂，模仿工作人員跳一段舞，維持 10 秒不 NG！', damage:5  },
  { id:5,  type:'task',  name:'【金句密碼】',             desc:'請到禮拜堂，解開一段聖經密碼，找出關鍵經文',                                                               name2:'歌大合唱',         desc2:'請到禮拜堂，全隊一起唱一首夏令營詩歌，拿出熱情', damage:10 },
  { id:6,  type:'task',  name:'【體能測試】',             desc:'請到禮拜堂，全隊一起完成開合跳 30 下',                                                                     name2:'跳繩挑戰',         desc2:'請到禮拜堂，全隊一起跳繩，累積跳繩 100 下',     damage:10 },
  { id:7,  type:'task',  name:'【失落的寶物】',           desc:'主日學教室藏了神秘物品，找到就有獎',                                                                       name2:'尋找密條',         desc2:'主日學教室藏有密條，找到可獲得寶藏',            damage:10 },
  { id:8,  type:'task',  name:'【潛行修煉】',             desc:'請到禮拜堂，地板不出聲到下一關，不能說話',                                                                 name2:'伏地挺身挑戰',     desc2:'請到禮拜堂，全隊一起做伏地挺身 10 下，撐下去', damage:5  },
  { id:9,  type:'task',  name:'【光天化日】',             desc:'和新生教會招牌和老師拍一張搞怪合照',                                                                       name2:'創意拍照',         desc2:'請到備課教室，按照指定動作拍照',                damage:10 },
  { id:10, type:'task',  name:'【智力風暴】',             desc:'請到會議室挑戰聖經知識考卷，通過他！',                                                                     name2:'白板劇場',         desc2:'請到禮拜堂，白板上畫出一個戲劇，讓大家猜劇名',              damage:10 },
  ...
  { id:13, type:'task',  name:'【十字架拼】',             desc:'請到主日學教室合力拼完成一個十字架或教會主題圖案',                                                         name2:'神隊友配對',       desc2:'請到禮拜堂，將球池的球依顏色分類',                          damage:10 },
  { id:14, type:'task',  name:'【命運的籌組】',           desc:'請到禮拜堂，抽四張牌，必須加減成指定的數字',                                                               name2:'紙飛機',           desc2:'請到禮拜堂，折 10 架紙飛機，不超過指定區域',    damage:10 },
  { id:15, type:'task',  name:'【飲用聖水】',             desc:'到備課室全隊把飲料喝完',                                                                                   name2:'指定挑戰',         desc2:'找工作人員領取指定挑戰並完成，才算過關',        damage:10 },
  { id:16, type:'task',  name:'【聖經接龍】',             desc:'到會議室接力說出聖經金句，看誰最不會卡',                                                                   name2:'用瓶高手',         desc2:'請到禮拜堂，成功甩寶特瓶 5 次',                         damage:10 },
];
