var SQUARES = [
  ...
  { id:5,  type:'task',  name:'【密室解碼：背金句】',   desc:'請到會議室，全隊派出一名代表（或接力），一字不漏地背誦出指定本週金句。',                                  name2:'合唱詩歌',       desc2:'請到會議室，全隊合唱一首夏令營歌曲。',                              damage:10 },
  { id:6,  type:'task',  name:'【體能試煉：開合跳】',   desc:'請到車棚，全隊一起完成開合跳 30 下（或累積加總 100 下），動作須整齊劃一。',                               name2:'最快排列',       desc2:'請到車棚，全隊累積跳繩 100 下。',                                damage:10 },
  { id:7,  type:'task',  name:'【失落的教會寶物】',     desc:'請到主日學教室，根據關主提示找出隱藏的「聖經故事道具」，找到後回來。',                              name2:'找紙條',         desc2:'請到主日學教室，找到工作人員藏的紙條並唸出來',              damage:10 },
  { id:8,  type:'task',  name:'【不倒翁修煉】',          desc:'原地金雞獨立直到下回合。',                                                                                 name2:'全隊伏地挺身',   desc2:'原地全隊同時做伏地挺身 5 下',                               damage:5  },
  ...
  { id:15, type:'task',  name:'【備課室的聖水試煉】',   desc:'請到備課教室，全隊輪流接力（或用超長吸管），將指定特調飲料（如：苦茶、或是混搭飲料）全部喝完。',         name2:'蓋章任務',       desc2:'請到備課教室，找到工作人員並完成一個指定挑戰。',                            damage:10 },
